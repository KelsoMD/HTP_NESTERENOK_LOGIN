...
<body>
	<section class="menu cid-qLBklWUHGk" id="menu1-h">
		<nav
			...
			<div class="menu-logo">
				<div class="navbar-brand">
					<span class="navbar-logo"> <a>
							<img src="assets/images/logocbs-345x345.png" alt="Mobirise"
							title="" style="height: 5.3rem;">
					</a>
					</span> <span class="navbar-caption-wrap"><a
						class="navbar-caption text-primary display-5"
						>Library Web Project</a></span>
				</div>
			</div>
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<div class="navbar-buttons mbr-section-btn">
					<a class="btn btn-sm btn-primary display-4"
						href="http://localhost:8080/login/MainServlet?action=switch_login">Войти</a>
					<a class="btn btn-sm btn-primary display-4"
						href="http://localhost:8080/login/MainServlet?action=switch_reg"> Регистрация</a>
				</div>
			</div>
		</nav>
	</section>
		...
		<div class="container">
			<div class="row justify-content-md-center">
				<div class="mbr-white col-md-10">
					...
					<h3
						class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2">Вэб-проект
						"Библиотека"</h3>
					<p class="mbr-text align-center pb-3 mbr-fonts-style display-5">Данный
						веб проект представляет собой веб-сайт библиотеки, где любой
						желающий может ознакомиться с правилами библиотеки, ассортиментом
						книг, оформить карту читателя.</p>
