		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="title col-12 col-lg-8">
					<h2
						class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">Вы уже вошли в систему как</h2>
					<h3
			...
			<div class="row justify-content-center">
				<div class="media-container-column col-lg-8">
					<form class="mbr-form" action="MainServlet" method="get">
						...
						<span class="input-group-btn"><input type="hidden" name="action" value="main_page"/>
