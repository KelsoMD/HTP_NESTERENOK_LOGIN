								...
								<c:forEach items="${list}" var="item">
									<tr>
										...
										<td class="body-item mbr-fonts-style display-7"><a
											href="http://localhost:8080/login/MainServlet?action=delete_book&book_id=${item.getId()}&prevTitle=${prevTitle}&search=books">DELETE </a><a
											href="http://localhost:8080/login/MainServlet?action=edit_book&book_id=${item.getId()}">EDIT </a>
											<a
											href="http://localhost:8080/login/MainServlet?action=update_count&book_id=${item.getId()}&prevTitle=${prevTitle}&search=books">ADD</a>
									</tr>
								</c:forEach>
							</tbody>
						</table>
