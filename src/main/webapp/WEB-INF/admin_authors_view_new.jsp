...
<body>
	...
	<section
		class="mbr-section form1 cid-qN84TDWaPu mbr-parallax-background" id="header1-i">
		<div class="container">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="media-container-column col-lg-8"><br>
				 <div data-form-alert="" hidden="">Ваше сообщение успешно отправлено!</div><br>
					<form class="mbr-form" action="MainServlet" method="get">
						...
						<span class="input-group-btn"><input type="hidden"
							name="action" value="find_author_search">
					...
					<table class="table isSearch">
						<thead>
							<tr class="table-heads ">
								<th class="head-item mbr-fonts-style display-7">Фамилия</th>
								<th class="head-item mbr-fonts-style display-7">Имя</th>
								<th class="head-item mbr-fonts-style display-7">Год рождения</th>
